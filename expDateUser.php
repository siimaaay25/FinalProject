...
?>
<h5 align="center" style="color:blue"> Expenses Report from <?php echo $fdate?> to <?php echo $tdate?></h5>
<hr />
			  ...
			  <th>Expenses Time</th>
                                       ...
                                       <?php
$ret=mysqli_query($con,"select *from expenses where date(expTime) between '$fdate' and '$tdate' ");
$cnt=1;
