    ...
    echo $msg;
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Amount that you want to pay</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="dues" name="dues" placeholder="Amount that you want to pay" class="form-control" required="true">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="username" name="username" placeholder="Username" class="form-control" maxlength="10" required="true">
