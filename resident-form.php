...
$floor=$_POST['floor'];
 ...
 $query=mysqli_query($con,"insert into tblvisitor(ResidentName,MobileNumber,Address,Apartment,Floor) value('$visname','$mobnumber','$add','$apart','$floor')");
    ...
    echo $msg;
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Resident Name</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="visname" name="visname" placeholder="Resident Name" class="form-control" required="true">
